...
<section class="section text-white">
    ...
    <div class="section-overlay">
        <img src="<?= base_url('assets/images/DarkHourChat_Banner_Female3.webp'); ?>"  alt="A private conversation is one call away" class="size-full object-cover opacity-50"/>
    </div>
</section>
