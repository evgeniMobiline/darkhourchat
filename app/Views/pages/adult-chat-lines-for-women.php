...
<section class="section banner">
    ...
    <div class="section-overlay">
        <img src="<?= base_url('assets/images/DarkHourChat_banner_woman.webp'); ?>"  alt="Adult Chat Lines for Women" class="size-full object-cover opacity-60"/>
    </div>
</section>
...
<section class="section">
    <div class="container">
        ...
        <div class="text-center mt-12">
            <a href="/how-adult-chat-line-works" class="btn">How Chat Line Works</a>
        </div>
    </div>
</section>
...
<section class="border-y bg-black/30 section">
    <div class="container">
        ...
        <div class="text-center mt-12">
            <a href="/adult-chat-lines-for-men" class="btn">Adult Chat Lines for Men</a>
        </div>
    </div>
</section>
    ...
    <div class="section-inner">
        <div class="container">
            <div class="max-w-5xl mx-auto text-center">
                <?= render_content($content['s_8']); ?>
            </div>
        </div>
    </div>
    <div class="section-overlay">
        <img src="<?= base_url('assets/images/DarkHourChat_Banner_Female1.webp'); ?>"  alt="Make a Connection" class="size-full object-cover opacity-50"/>
    </div>
</section>
