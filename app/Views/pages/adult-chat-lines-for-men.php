...
<section class="section banner">
    ...
    <div class="section-overlay">
        <img src="<?= base_url('assets/images/DarkHourChat_banner_man.webp'); ?>"  alt="Adult Chat Line for Men" class="size-full object-cover opacity-50"/>
    </div>
</section>
...
<section class="section text-white">
    ...
    <div class="section-overlay">
        <img src="<?= base_url('assets/images/DarkHourChat_Banner_Male1.webp'); ?>" alt="Make a Connection" class="size-full object-cover opacity-50" />
    </div>
</section>
