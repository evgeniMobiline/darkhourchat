...
return [
    'entry' => [
        ...
        [
            [
                'entry' => 'Account Registration and Security',
                'tag'   => 'h2',
                'class' => 'mb-2'
            ],
            [
                'entry' => "When you register, you may receive a membership number and create a passcode."
            ],
            [
                'entry' => "You are responsible for:"
            ],
            [
                'entry' => [
                    [
                        'entry' => "Keeping your membership number private",
                        'tag'   => 'li'
                    ],
                    [
                        'entry' => "Keeping your passcode secure",
                        'tag'   => 'li'
                    ],
                    [
                        'entry' => "All activity under your account",
                        'tag'   => 'li'
                    ],
                ],
                'tag'   => 'ul',
        ...
        [
            ...
            [
                'entry' => [
                    [
                        'entry' => "Advertise products or services",
                        'tag'   => 'li'
                    ],
                    [
                        'entry' => "Collect personal data from other users",
                        'tag'   => 'li'
                    ],
                    [
                        'entry' => "Share other users’ contact information",
                        'tag'   => 'li'
                    ],
                    [
                        'entry' => "Use the Service for illegal or commercial purposes",
                        'tag'   => 'li'
                    ],
                ],
                'tag'   => 'ul',
        ...
        [
            [
                'entry' => 'On-Phone Conduct',
                'tag'   => 'h2',
                'class' => 'mb-2'
            ],
            [
                'entry' => "You are responsible for any greetings, recordings, or messages you create."
            ],
            [
                'entry' => "You agree not to engage in:"
            ],
            [
                'entry' => [
                    [
                        'entry' => "Illegal activity",
                        'tag'   => 'li'
                    ],
                    [
                        'entry' => "Threats or harassment",
                        'tag'   => 'li'
                    ],
                    [
                        'entry' => "Hate speech or discrimination",
                        'tag'   => 'li'
                    ],
                    [
                        'entry' => "Impersonation or fraud",
                        'tag'   => 'li'
                    ],
                    [
                        'entry' => "Sharing explicit personal contact details",
                        'tag'   => 'li'
                    ],
                ],
                'tag'   => 'ul',
            ...
            [
                'entry' => "Violations may result in suspension or termination."
            ],
        ],
        [
            [
                'entry' => 'Service Suspension and Termination',
                'tag'   => 'h2',
                'class' => 'mb-2'
            ],
            [
        ...
        [
            [
                'entry' => 'Payments and Charges',
                'tag'   => 'h2',
                'class' => 'mb-2'
            ],
            [
                'entry' => "Some features require payment."
            ],
            [
                'entry' => "By purchasing minutes or packages, you agree to pay all charges and applicable taxes."
            ],
            [
                'entry' => "All purchases are final unless required by law. Prices may change at any time."
            ],
            [
                'entry' => "Long-distance charges may apply depending on your phone provider."
            ],
        ],
        [
            [
                'entry' => 'Limitation of Liability',
                'tag'   => 'h2',
                'class' => 'mb-2'
            ],
            [
        ...
        [
            ...
            [
                'entry' => "These Terms are governed by the laws of the State of Texas, United States."
            ],
            [
                'entry' => "Any disputes must be handled in courts located in Texas."
            ],
        ],
        [
            [
